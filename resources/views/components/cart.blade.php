<span class="relative inline-block">
    ...
    {{-- <span
        class="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-secondary transform translate-x-1/2 -translate-y-1/2 bg-white rounded-full">99</span> --}}
    <span
